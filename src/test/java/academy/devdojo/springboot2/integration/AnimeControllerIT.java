...
class AnimeControllerIT {
    ...
    @Autowired
    private StefanyUserRepository stefanyUserRepository;
    private static final StefanyUser USER = StefanyUser.builder()
            .name("Stefany")
            .password("{bcrypt}$2a$10$DyyD5y5bhDEzXEfV7wWf6eZho5wm/d29vS0om17Eg26.h/AOwd/0i")
            .username("stefany")
            .authorities("ROLE_USER")
            .build();

    private static final StefanyUser ADMIN = StefanyUser.builder()
            .name("Stefany Silveira")
            .password("{bcrypt}$2a$10$DyyD5y5bhDEzXEfV7wWf6eZho5wm/d29vS0om17Eg26.h/AOwd/0i")
            .username("stefany")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("stefany", "academy");
    ...
    void list_ReturnsListOfAnimesInsidePageObject_WhenSuccessful() {
        ...
        stefanyUserRepository.save(USER);
    ...
    void delete_RemovesAnime_WhenSuccessful() {
        Anime savedAnime = animeRepository.save(AnimeCreator.createAnimeToBeSaved());
        stefanyUserRepository.save(ADMIN);
